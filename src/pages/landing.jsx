            ...
            <div className="osahan-started pt-2 text-center">
                ...
                <div className="head py-4 px-4 text-center">
                    ...
                    <p className="text-muted">
                        I'm an early bird and I'm night owl so I'm
                        <br />
                ...
                <div className="osahan-footer fixed-bottom p-3">
                    <Link
                        to="/signin"
                        className="btn btn-outline-success btn-lg w-100 shadow mb-3"
                    >
                        SIGN IN
                    </Link>
                    <Link
                        to="/signup"
                        className="btn btn-outline-primary btn-lg w-100 shadow"
                    >
                        CREATE AN ACCOUNT
                    </Link>
                </div>
